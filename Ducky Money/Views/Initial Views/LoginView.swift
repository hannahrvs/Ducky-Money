        ...
        NavigationView {
            VStack {
                ...
                Text("Welcome back! Glad to see you, Again!")
                  .font(Font.custom("Arial Rounded MT Bold", size: 31.56253).weight(.bold))
                  .foregroundColor(Color(red: 0.12, green: 0.14, blue: 0.17))
                  .frame(width: 294.58359, alignment: .topLeading)
                Spacer()
                TextField("Email", text: $email)
                    ...
                    .frame(width: 320)
                    .padding()
                    .background(RoundedRectangle(cornerRadius: 8.41667).stroke(Color(red: 0.91, green: 0.93, blue: 0.96), lineWidth: 1.05))
                ...
                .background(
                    NavigationLink(
                        destination: TabViewClass().navigationBarHidden(true),
